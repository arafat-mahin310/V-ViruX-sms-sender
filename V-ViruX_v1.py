...
____    ____  __  .______       __    __  ___   ___ 
\   \  /   / |  | |   _  \     |  |  |  | \  \ /  / 
 \   \/   /  |  | |  |_)  |    |  |  |  |  \  V  /  
  \      /   |  | |      /     |  |  |  |   >   <   
   \    /    |  | |  |\  \----.|  `--'  |  /  .  \  
    \__/     |__| | _| `._____| \______/  /__/ \__\ 
       ...
       TOOLS     \033[1;91m: \033[1;92mSms-ViruX              
       GITHUB    \033[1;91m: \033[1;92marafatmahin310           
       FACEBOOK  \033[1;91m: \033[1;92Arafat Mahin          
...
while amount>ses:
  ...
  if sent1.status_code==200:
    ses+=1
    print(f"\n[{ses}] \033[1;32m SMS SENT Complete )
  else:
    pass
